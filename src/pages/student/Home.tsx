...
import { checkApplicationStatus } from "../../api/tutorApi";
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white font-sans">
      ...
      {/* Hero Section */}
      <header className="flex flex-col-reverse md:flex-row items-center justify-between px-4 sm:px-8 md:px-16 py-16 sm:py-20 gap-10">
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <Link to="/signup">
            <button className="w-full sm:w-auto bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-blue-600 hover:to-cyan-500 text-white font-medium px-6 py-3 rounded-xl shadow-md transition-transform transform hover:scale-105 text-sm">
              Start Learning Music
            </button>
          </Link>
        </div>
        <div className="w-full md:w-1/2">
          <Lottie animationData={learn} loop className="w-full h-auto max-h-[300px] sm:max-h-[380px] mx-auto" />
        </div>
      </header>

      {/* Features Section */}
      <section className="px-4 sm:px-8 md:px-16 py-12 sm:py-16 bg-gray-900">
        <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-center mb-8 sm:mb-10">
          Why Learn Music with Us?
        </h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 text-center">
          <Feature title="Live & Recorded Classes" description="Attend live sessions or learn at your own pace with high-quality recorded lessons." icon="🎼" />
          <Feature title="Instrument-Specific Training" description="Choose from Guitar, Piano, Drums, Violin, Vocals, and more." icon="🎸" />
          <Feature title="Learn from Experts" description="Our experienced musicians will guide you from beginner to pro." icon="👨‍🏫" />
        </div>
      </section>

      {/* CTA Section */}
      <section className="px-4 sm:px-8 md:px-16 py-12 sm:py-16 text-center bg-gradient-to-r from-cyan-600 to-blue-600">
        <h4 className="text-lg sm:text-xl md:text-2xl font-semibold mb-4">
        ...
        <Link to="/signup">
          <button className="w-full sm:w-auto bg-black text-white px-6 py-3 rounded-lg font-medium hover:bg-gray-900 transition">
      ...
      <section className="px-4 sm:px-8 md:px-16 py-12 sm:py-16 bg-gray-950">
        <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-center mb-8 sm:mb-10">
          Top Related Courses
        </h3>
      ...
      <section className="px-4 sm:px-8 md:px-16 py-12 sm:py-16 text-center bg-gradient-to-r from-cyan-600 to-blue-600">
        ...
        <button onClick={handleApplicationStatus} className="w-full sm:w-auto bg-black text-white px-6 py-3 rounded-lg font-medium hover:bg-gray-900 transition text-sm">
          Become a Tutor
        </button>
      </section>
